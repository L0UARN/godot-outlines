...
layout(rgba8, set = 0, binding = 0) uniform restrict readonly image2D input_image_1;
layout(rgba8, set = 1, binding = 0) uniform restrict writeonly image2D output_image;
layout(rgba8, set = 2, binding = 0) uniform restrict readonly image2D input_image_2;
...
void main() {
	...
	imageStore(output_image, current_position, (current_pixel_1 + current_pixel_2) * 0.5f);
}