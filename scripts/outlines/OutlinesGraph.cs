...
namespace Outlines
{
	public class OutlinesGraph : ICleanupable
	{
		...
		public OutlinesGraph(int outlinesSize, int glowRadius, Rid rawImage)
		{
			...
			Ppcs.Abstractions.Shader jfaInit = new(renderingDevice, "res://assets/shaders/jfa_init.glsl");
			...
			{
				Ppcs.Abstractions.Shader nextJfaStep = new(renderingDevice, "res://assets/shaders/jfa_step.glsl");
			...
			Ppcs.Abstractions.Shader jfaOutlines = new(renderingDevice, "res://assets/shaders/jfa_outlines.glsl");
			...
			if (glowRadius > 0)
			{
				...
				Ppcs.Abstractions.Shader boxBlur1 = new(renderingDevice, "res://assets/shaders/box_blur.glsl");
				...
				Ppcs.Abstractions.Shader boxBlur2 = new(renderingDevice, "res://assets/shaders/box_blur.glsl");
				...
				Ppcs.Abstractions.Shader composite = new(renderingDevice, "res://assets/shaders/composite.glsl");
