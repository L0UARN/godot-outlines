...
void main() {
	...
	vec2 current_seed_position = vec2(float(packUnorm2x16(current_pixel.xy)), float(packUnorm2x16(current_pixel.zw)));
	...
	float distance_to_seed = distance(vec2(current_position), current_seed_position);
